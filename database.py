# database.py
#
# Methods to create and handle chess board and board feature databases
...
# Returns 37 global features of the board
def getGlobalFeatures(board):
    ...
    # Turn - 1 value
    feature[i] = int(board.turn)
    i += 1

    # Castling rights - 4 values
    feature[i] = int(board.has_queenside_castling_rights(True))
    i += 1
    feature[i] = int(board.has_kingside_castling_rights(True))
    i += 1
    feature[i] = int(board.has_queenside_castling_rights(False))
    i += 1
    feature[i] = int(board.has_kingside_castling_rights(False))
    i += 1

    # Piece counts for both sides - 32 values
    for p, c in pieces.iteritems():
...
# files = ['/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-A00-A39.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-A40-A79.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-A80-A99.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-B00-B19.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-B20-B49.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-B50-B99.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-C00-C19.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-C20-C59.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-C60-C99.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-D00-D29.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-D30-D69.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-D70-D99.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-E00-E19.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-E20-E59.pgn',
#          '/home/laptop/Documents/cs251/prj9/gameDB/pgn/KingBaseLite2016-03-E60-E99.pgn']

# # Build a fen DB from pgn files
# buildFenDB(files, 'fenDB.csv')

# # Shuffle the fen DB
# shuffleCSV('fenDB.csv', 'randomFenDB.csv')

# # Build a feature database
# buildFeatureDB('randomFenDB.csv', 'featDB.npy')
